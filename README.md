...
Based off of the user's selection, a series of relevent questions will be asked to obtain the necessary information to put into the database or to view a table already in the database. An example for adding and removing an employee is given below, but all of the application's questions can be viewed in the video linked above. 
